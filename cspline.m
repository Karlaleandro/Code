...
%Esta função calcula splines cúbicas para os dados de entrada(x,y)
%Entradas: x = [x0 x1 ... xN], y = [y0 y1 ... yN], xi=ponto a ser
%interpolado
% KC = 1/2 representa a condição de fronteira para a 1ª e 2ª derivada
%KC = 3 for para a 2ª derivada sobre a fronteira extrapolada
%dy0 = S’(x0) = S01: initial derivative
% dyN = S’(xN) = SN1: derivada final
%Saídas: S(n,k); n = 1:N, k = 1,4  em ordem decrescente
